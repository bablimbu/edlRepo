  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 h-[100vh] flex flex-col items-center justify-center">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff8080] to-[#3224f3] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Crafting Digital Dreams, One Pixel at a Time
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            A creative powerhouse offering web development, graphic design, video editing, and artistic solutions. Transforming ideas into digital masterpieces with innovation and precision.
